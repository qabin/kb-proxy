  ...
  methods: {
    render_nick_name(h) {
      return h('div', {
        ...
        !this.edit_nick_name ? h('div', {
          style: {
            overflow: 'hidden',
            textOverflow: 'ellipsis',
            whiteSpace: 'noWrap',
          },
        }, [this.user_info.nick_name, h('q-btn', {
          props: {
            icon: 'edit',
            color: 'primary',
            flat: true,
          ...
          h('q-input', {
            ...
            props: {
              placeholder: '请输入昵称',
              hideUnderline: true,
              value: this.user_info.nick_name
            },
            style: {
              width: '60%',
            },
            on: {
              input: (v) => this.user_info.nick_name = v
            }
          }),
          h('q-btn', {
            ...
            props: {
              ...
              flat: true,
              color: 'primary',
              disable: this.user_info.nick_name == null || this.user_info.nick_name.length <= 0 ? true : false
            },
            on: {
          ...
          h('q-btn', {
            ...
            on: {
              click: () => this.edit_nick_name = false
            }
          }),
        ]),
      ])
    ...
    render_detail(h) {
      return h('div', {
        ...
        h('div', {staticClass: 'col-12'}, [
          this.render_tr(h, '昵称', this.render_nick_name(h), 'font-14 text-weight-bold', 'q-pa-xs text-tertiary font-14 text-weight-bold'),
          this.render_tr(h, '端口', this.user_info.id, 'font-14 text-weight-bold', 'q-pa-xs text-tertiary font-14 text-weight-bold'),
          this.render_tr(h, '账号', this.user_info.login_name),
