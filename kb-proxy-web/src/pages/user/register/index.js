    ...
    return h('div', {
      ...
      h('div', {
        ...
        h('q-input', {
          ...
          on: {
            input: (v) => this.model.nick_name = v
          }
        }),
        h('q-input', {
        ...
        h('q-btn', {
          ...
          props: {
            color: 'primary',
            disable: this.model.login_name != null && this.model.login_name.length > 0 && this.model.login_pwd != null && this.model.login_pwd.length > 0 ? false : true,
          },
          on: {
            click: () => {
